...
<form method="post" action="edit" id="write_form">
  <div id="write_top">
    标题： <input type="text" name="article_title" id="title" tabindex="1" value="${article.title}" /><br/>
    作者： <input type="text" name="author"  tabindex="1" value="${article.author}" /><br/>
  ...
  <div style="width:860px; margin: 30px auto;">
    ...
    <a href="./?page=1"><button type="submit" class="btn btn-1 btn-1a" style="font-size: 16px;font-family: 微软雅黑">返回</button></a>
