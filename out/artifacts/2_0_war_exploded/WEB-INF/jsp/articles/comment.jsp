...
<div id="main">
  <div class="wrapper clearfix">
    ...
    <div id="posts-list" class="single-post">
      ...
      <h2 class="page-heading"  style="font-family: Microsoft YaHei"><span>${article.commentCounts}条评论</span></h2>
      ...
      <article class="format-standard">
          ...
          <ol class="commentlist">
            ...
            <li class="comment even thread-even depth-1" id="li-comment-1">
              ...
              <div id="comment-1" class="comment-body clearfix">
                ...
                <div class="comment-author vcard">${comment.username}</div>
        ...
        <form  method="post" id="commentform">
          <h3 class="heading"  style="font-family: Microsoft YaHei">填写评论</h3>
         ...
         <br/>
          ...
          <input type='hidden' name='articleId' value='${article.id}' id='comment_post_ID' />
